...
function createScoreboardGUI()
    if scoreboardWindow then return end
    
    local x = (screenW - SCOREBOARD_WIDTH) / 2
    local y = (screenH - SCOREBOARD_HEIGHT) / 2
    
    scoreboardWindow = guiCreateWindow(x, y, SCOREBOARD_WIDTH, SCOREBOARD_HEIGHT, "AMB Vietnamese Roleplay - Players Online", false)
...
function showScoreboard()
    ...
    -- Refresh player list
    if not scoreboardWindow then return end
